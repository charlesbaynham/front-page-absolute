{
  description = "Jekyll development environment for houseabsolute game projects";
      ...
      in {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "Jekyll development environment for houseabsolute game projects"
            echo ""
